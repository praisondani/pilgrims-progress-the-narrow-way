...
export const DREAM_COMPOSITION_ANCHORS: readonly DreamCompositionAnchor[] = [
  ...
  },
  {
    ...
    slots: [
      ...
      slot("tree", [-8.6, 1.5], 0.84, 0, -0.18, 0.08),
      slot("tree", [8.6, 1.45], 0.88, 0, 0.2, 0.08),
      slot("tree", [-9.8, -1.35], 0.7, 1, 0.06, 0.1),
      slot("shrub", [-8.9, -0.3], 0.72, 0, 0, 0.1),
      slot("shrub", [8.9, -0.25], 0.74, 1, 0, 0.1),
      slot("grass", [-7.4, 0.9], 0.82, 1),
      slot("grass", [7.4, 0.82], 0.84, 2),
      slot("rock", [-9.4, -1.05], 0.58, 0, 0.4, 0.08),
      slot("rock", [9.4, -0.95], 0.54, 1, -0.35, 0.08),
      slot("reed", [-8.7, -1.5], 0.72, 1, 0, 0.08),
      slot("reed", [8.7, -1.45], 0.76, 2, 0, 0.08),
      slot("groundPatch", [-8.6, 0.2], 1.4, 2, 0, 0.06),
      slot("ridge", [9.6, -1.4], 0.72, 2, 0, 0.06),
    ],
  },
  {
